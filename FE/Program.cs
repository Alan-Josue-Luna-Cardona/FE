...
void Inicar()
{
    ...
    nave = new Nave(new Point(80, 30), ConsoleColor.DarkBlue, ventana);

    enemigo1 = new Enemigo(new Point(50, 10), ConsoleColor.Red, ventana, TipoEnemigo.Normal,
        nave);
    enemigo2 = new Enemigo(new Point(20, 12), ConsoleColor.Yellow, ventana, TipoEnemigo.Normal,
        nave);
